...
KUBE_CLI=kubectl
OPERATOR_VERSION := amq-broker-7.13-rhel-9-containers-candidate-35762-20250922173515
...
# Add a new line here if you would like to change its default config. (E.g CHANNELS = 7.13.x
CHANNELS = 7.13.x
...
# Add a new line here if you would like to change its default config. (E.g DEFAULT_CHANNEL = 7.13.x
DEFAULT_CHANNEL = 7.13.x
