...
# Add a new line here if you would like to change its default config. (E.g CHANNELS = 7.10.x
CHANNELS = 7.10.x
...
# Add a new line here if you would like to change its default config. (E.g DEFAULT_CHANNEL = 7.10.x
DEFAULT_CHANNEL = 7.10.x
