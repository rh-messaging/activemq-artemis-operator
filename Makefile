...
KUBE_CLI=kubectl
OPERATOR_VERSION := amq-broker-8.0-openshift-rhel-8-containers-candidate-57883-20240412163429
...
## Tool Versions
KUSTOMIZE_VERSION ?= 7.x.x-opr-1
CONTROLLER_TOOLS_VERSION ?= 7.x.x-opr-1
