...
MANAGER_VERSION := 7.14.0.OPR.1.CR1
...
# Add a new line here if you would like to change its default config. (E.g CHANNELS = 7.14.x
CHANNELS = 7.14.x
...
# Add a new line here if you would like to change its default config. (E.g DEFAULT_CHANNEL = 7.14.x
DEFAULT_CHANNEL = 7.14.x
