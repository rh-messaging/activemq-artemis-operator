...
FROM registry.redhat.io/ubi9/go-toolset:1.25.9 AS builder
...
FROM registry.redhat.io/ubi9/ubi-minimal@sha256:c7d44146f826037f6873d99da479299b889473492d3c1ab8af86f08af04ec8a0 as base-env
...
LABEL name="amq7/amq-broker-rhel9-operator"
LABEL description="Red Hat AMQ Broker 7.13 Operator"
LABEL maintainer="Roddie Kieley <rkieley@redhat.com>"
LABEL version="7.13.4"
LABEL summary="Red Hat AMQ Broker 7.13 Operator"
LABEL amq.broker.version="7.13.4.OPR.1.CR2"
LABEL com.redhat.component="amq-broker-rhel9-operator-container"
LABEL io.k8s.display-name="Red Hat AMQ Broker 7.13 Operator"
