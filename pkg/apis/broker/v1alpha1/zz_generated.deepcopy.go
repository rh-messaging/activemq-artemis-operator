...
func (in *AMQPodStatus) DeepCopyInto(out *AMQPodStatus) {
	*out = *in
	if in.Ready != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AMQPodStatus.
func (in *AMQPodStatus) DeepCopy() *AMQPodStatus {
	if in == nil {
		return nil
	}
	out := new(AMQPodStatus)
	in.DeepCopyInto(out)
	return out
}
