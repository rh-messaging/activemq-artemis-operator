...
LABEL operators.operatorframework.io.bundle.package.v1=amq-broker-operator
LABEL operators.operatorframework.io.bundle.channels.v1=7.12.x
LABEL operators.operatorframework.io.bundle.channel.default.v1=7.12.x
...
LABEL amq.broker.version="7.12.0.OPR.1.CR1"
LABEL com.redhat.component="amq-broker-rhel8-operator-bundle-container"
LABEL com.redhat.delivery.backport=false
LABEL com.redhat.delivery.operator.bundle=true
LABEL com.redhat.openshift.versions="v4.12"
LABEL io.k8s.display-name="Red Hat AMQ Broker 7.12 Operator Bundle"
