			...
			if os.Getenv("USE_EXISTING_CLUSTER") == "true" {
				...
				if isOpenshift {
					...
					Eventually(func(g Gomega) {
						...
						g.Expect(ingress.Spec.Rules[0].Host).To(ContainSubstring("www.mgmtconsole.com"))
						...
						g.Expect(ingress.Spec.TLS[0].Hosts[0]).To(ContainSubstring("www.mgmtconsole.com"))
					...
					Eventually(func(g Gomega) {
						...
						g.Expect(ingress.Spec.Rules[0].Host).To(Equal(brokerCr.Name + "-amqp-ssl-0-svc-ing." + "www.mgmtconsole.com"))
						g.Expect(len(ingress.Spec.Rules[0].HTTP.Paths)).To(BeEquivalentTo(1))
						...
						g.Expect(len(ingress.Spec.TLS)).To(BeEquivalentTo(1))
						g.Expect(len(ingress.Spec.TLS[0].Hosts)).To(BeEquivalentTo(1))
						g.Expect(ingress.Spec.TLS[0].Hosts[0]).To(Equal(brokerCr.Name + "-amqp-ssl-0-svc-ing." + "www.mgmtconsole.com"))
					...
					Eventually(func(g Gomega) {
						...
						g.Expect(len(ingress.Spec.Rules)).To(Equal(1))
						g.Expect(ingress.Spec.Rules[0].Host).To(Equal(brokerCr.Name + "-connector-ssl-0-svc-ing." + "www.mgmtconsole.com"))
						g.Expect(len(ingress.Spec.Rules[0].HTTP.Paths)).To(BeEquivalentTo(1))
						...
						g.Expect(len(ingress.Spec.TLS)).To(BeEquivalentTo(1))
						g.Expect(len(ingress.Spec.TLS[0].Hosts)).To(BeEquivalentTo(1))
						g.Expect(ingress.Spec.TLS[0].Hosts[0]).To(Equal(brokerCr.Name + "-connector-ssl-0-svc-ing." + "www.mgmtconsole.com"))
	...
	Context("Labels Test", func() {
		It("passing in 2 labels", func() {
			...
			Eventually(func(g Gomega) {
				...
				g.Expect(len(createdSs.Spec.Template.Labels)).Should(BeNumerically("==", 4+len(pods.GetAdditionalLabels(version.Version))))
