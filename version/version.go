...
const (
	...
	LatestKubeImage = "registry.redhat.io/amq7/amq-broker-rhel8:8.0.0" + LatestVersion
	LatestInitImage = "registry.redhat.io/amq7/amq-broker-init-rhel8:8.0.0" + LatestVersion
)
...
var ActiveMQArtemisVersionfromFullVersion map[string]string = map[string]string{
	"8.0.0": "2.34.0.temporary-redhat-00009",
}
